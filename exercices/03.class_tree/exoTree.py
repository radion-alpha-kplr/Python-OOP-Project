...
def main():
    ...
    my_tree.create_node(tag="Product Classes Hierarchy", identifier="Product Classes Hierarchy")
    ...
    create_tree_from_dict(my_tree, "Product Classes Hierarchy", json_dict)
